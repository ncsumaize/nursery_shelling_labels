...
![A script is used to combine input file information, add additionl information, then call the createLabels() function of the nursery module](Workflow_main_shelling label_script.png?raw=true)
